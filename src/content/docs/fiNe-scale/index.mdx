...
> We hire a large hall and assemble a layout from model railway modules with matching end
> profiles. Trains then travel loooong distances – operated according to the timetable.
>
...
## Track Construction
Standard N-gauge models are typically built to NEM standards (Normen Europäischer Modellbahnen). Established in the mid-1960s, these standards were designed for children's toys, allowing for extremely tight track radii (approx. 20 cm). This requires significant compromises: wheels are disproportionately wide, while rail profiles and wheel flanges are excessively high.
...
There are sligtly similar ways to build points and track. Be sure to check out
[Henk Oversloot’s FS160 pages](https://www.fs160.eu/) as well. 

I’ve gained a lot of valuable insight from both Jens and Henk; they are truly
great mentors.

For more informations, impressions and guides have a look on my [fiNe-scale Resources page](./resources.mdx).

import { LinkCard } from '@astrojs/starlight/components';

<LinkCard title="Weichenbauanleitung ew190.pdf" description="Construction manual for the EW 190 1:9 simple turnout in 1:160 scale (german only)" href="/Weichenbauanleitung ew190.pdf" />
