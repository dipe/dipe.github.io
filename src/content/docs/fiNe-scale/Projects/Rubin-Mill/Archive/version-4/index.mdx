...
<Aside type="caution" title="Outdated Version">
  This is an archived previous version. [See here for the current one](/fine-scale/projects/rubin-mill/).
</Aside>
...
> Description from left to right: Embankment with
> greenery and slag stones, warehouse, main building, silo II, silo III,
> transition to further module (top), elevator (bottom) and then continue on the
> right segment: chimney, boiler house, heavy oil tank, embankment made of slag
> stones
>
...
| 2a | 190 |  | Flour and bran (pallets and sacks) | Gs |
| 2a | 190 | Packaging material (pallets and sacks) |  | Gs |
| 2a | 190 | Additives (pallets and sacks) |  | Gs |
| 2b | 400 | Grain |  | Tdgs, Uagpps, Tals, Tms, Klmmvs, Tanoos, Fcs |
| 2c | 400 | Machine parts |  | Ks |
| 2d | 265 | Heavy fuel oil |  | Z |
| 3a | 190 |  | Grain (pallets and sacks) | Gs, Hs |
| 3a | 190 |  | Mill products for export (pallets and sacks, via quay) | Hs |
| 3b | 210 |  | Grain (direct transfer) | Tdgs, Uagpps, Tals, Tms, Klmmvs |
...
> Green: FREMO module adapter, single track; brown: the two segment boxes;
> black: tracks
>
> ![Fremo Adapter](./fremo-adapter.png)  
...
| **Date** | **Description** |
| :---: | :---- |
| **2026-05-18:** | [Here is the next iteration (#7)](/fine-scale/projects/rubin-mill/archive/version-7/) |
| **2026-03-05:** | This is the 4th iteration |
