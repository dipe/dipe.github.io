...
>
> ![Rubin Mill Logo](./rubinmehl-logo.png)
...
(≙&nbsp;~119&nbsp;cm) with Code&nbsp;40 N scale track (FS160). The industrial site is
connected to an imaginary through-line of the Hamburg Harbour Railway (Hamburger
Hafenbahn).
...
**Goods dispatch**
- Flour in bulk (for large bakeries), Ucs dust container wagon, track 2a 
- Flour and bran in sacks, covered goods wagons (Gs), track 2b
- Mill products for export (via quay): sliding wall wagons (Hs), track 2b
...
Green: FREMO module adapter, pure landscape; brown: the two segment boxes; black:
tracks
...
>
> ![Aurora mill main building](./aurora-mill-1.jpg)
...
>
> ![Google maps view](./google-maps.png)
...
| **2026-03-05:** | [here is the 4th iteration](./archive/version-4/) |